# ML23/24: Implement Anomaly Detection Sample
...
* After that, the method BuildHTMInput of [CSVToHTMInput] class is there which converts all the read sequences to a format suitable for HTM training.
```csharp
